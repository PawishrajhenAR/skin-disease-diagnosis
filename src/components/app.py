...
RECOMMENDATIONS = {
    "Pigmented Benign Keratosis": ["Monitor for changes", "Use sunscreen", "Consult dermatologist if concerned"],
    "Melanoma": ["Seek immediate medical attention", "Schedule a biopsy", "Monitor for changes in size or color"],
    "Vascular Lesion": ["Consult dermatologist", "Protect from trauma", "Monitor for changes"],
    "Actinic Keratosis": ["Use sunscreen", "Consider cryotherapy", "Regular skin checks"],
    "Squamous Cell Carcinoma": ["Seek immediate medical attention", "Schedule a biopsy", "Protect from sun exposure"],
    "Basal Cell Carcinoma": ["Consult dermatologist immediately", "Schedule a biopsy", "Protect from sun exposure"],
    "Seborrheic Keratosis": ["Monitor for changes", "Avoid irritation", "Consult dermatologist if concerned"],
    "Dermatofibroma": ["Monitor for changes", "Avoid irritation", "Consult dermatologist if concerned"],
    "Nevus": ["Monitor for changes", "Avoid excessive sun exposure", "Regular skin checks"]
}
